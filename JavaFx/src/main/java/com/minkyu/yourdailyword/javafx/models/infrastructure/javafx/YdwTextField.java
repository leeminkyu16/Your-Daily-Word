...
public class YdwTextField extends TextField implements YdwView {
	...
	public YdwTextField(YdwObservable<String> stringYdwObservable) {
		this.setText(stringYdwObservable.get());
