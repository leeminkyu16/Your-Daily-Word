...
public class YdwStyleBundle {
    ...
    public YdwStyleBundle setMinWidth(double minWidth) {
        return this.addStyleAndReturnThis("-fx-min-width: " + minWidth + ";");
    }

    public YdwStyleBundle setMinHeight(double minHeight) {
        return this.addStyleAndReturnThis("-fx-min-height: " + minHeight + ";");
    }

    public YdwStyleBundle setPrefWidth(double prefWidth) {
        return this.addStyleAndReturnThis("-fx-pref-width: " + prefWidth + ";");
    }

    public YdwStyleBundle setPrefHeight(double prefHeight) {
        return this.addStyleAndReturnThis("-fx-pref-height: " + prefHeight + ";");
    }

    public YdwStyleBundle setMaxWidth(double maxWidth) {
        return this.addStyleAndReturnThis("-fx-max-width: " + maxWidth + ";");
    }

    public YdwStyleBundle setMaxHeight(double maxHeight) {
        return this.addStyleAndReturnThis("-fx-max-height: " + maxHeight + ";");
    }
    ...
    public void apply(Node node) {
        node.setStyle(this.buildStyleString());
    ...
    public static class StyleClasses {
        ...
        public static final String STANDARD_VBOX = "standard-vbox";
        public static final String STANDARD_MENU_BAR = "standard-menu-bar";
        public static final String STANDARD_MENU = "standard-menu";
        public static final String STANDARD_MENU_ITEM = "standard-menu-item";
        public static final String STANDARD_SEPARATOR = "standard-separator";
        public static final String STANDARD_COMBO_BOX = "standard-combo-box";
        public static final String STANDARD_LABEL = "standard-label";
    }
