...
public class CreateQuotesCenterGridPaneView extends YdwGridPane {
	...
	public CreateQuotesCenterGridPaneView(
		...
		this.add(
			new YdwLabel(internationalizationModel.getString("calendar_type"))
				.applyStyleBundleAndReturnThis(
					new YdwStyleBundle()
						.setBackgroundColor(
							YdwColorConstants.primaryBackgroundColor
						)
		...
		YdwComboBox<CalendarTypeModel> calendarTypeComboBox = new YdwComboBox<>(
			...
			new YdwStyleBundle()
				.addStyleClassAndReturnThis(YdwStyleBundle.StyleClasses.STANDARD_COMBO_BOX)
		);

		YdwLabel optionLabel = new YdwLabel();
		YdwCheckBox optionCheckbox = new YdwCheckBox()
			.applyStyleBundleAndReturnThis(
				new YdwStyleBundle()
					.addStyleClassAndReturnThis(YdwStyleBundle.StyleClasses.PRIMARY_CHECKBOX)
			);
