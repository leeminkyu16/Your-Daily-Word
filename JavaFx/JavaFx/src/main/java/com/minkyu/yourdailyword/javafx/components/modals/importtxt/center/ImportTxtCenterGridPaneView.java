...
public class ImportTxtCenterGridPaneView extends YdwGridPane {
	...
	public ImportTxtCenterGridPaneView(
		...
		this.safeAdd(
			new YdwLabel(internationalizationModel.getString("month_header"))
		...
		YdwLabel selectedFileLabel = new YdwLabel(
		...
		this.add(
			new YdwLabel(internationalizationModel.getString("close_on_import"))
				.applyStyleBundleAndReturnThis(
					new YdwStyleBundle()
						.setBackgroundColor(YdwColorConstants.primaryBackgroundColor)
						.setTextFill(YdwColorConstants.secondaryTextColor)
